...
// Jesús estaría almacenado en la variable: empleados[0], Alberto en: empleados[1] y Claudia en: empleados[2]
/*
fun main() {

    val empleados = arrayOf("Jesús", "Alberto", "Claudia", 45, 38)   // Con arrayOf podemos obtener cualquier tipo de dato, pero
                                                                     // si queremos un arreglo con tipos de datos muy específicos
    println(empleados[3])                                            // podemos poner por ejemplo: intArrayOf para números enteros.
}
*/
...
fun main() {
    ...
    valores[0] = 500     // Reasignamos el elemento de 1 a 500, por tanto también imprime 500

    println(valores[0])
}

// Si la variable en la que tenemos el arreglo es de tipo "val" no podemos reasignar, solo modificar los elementos que se encuentran dentro 1 * 1
// Con la variable de tipo var, sí podemos reasignar el tamaño del arreglo
